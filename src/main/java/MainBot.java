...
public class MainBot extends TelegramLongPollingBot {
    static String BotUsername ="@der_ru_tur_uz_bot";
    static String BotToken ="5064411268:AAHp1lF_FV5rE7bXaj5F-8S6xUzs3SdgDUk";
        ...
        if (update.hasMessage()) {
            ...
            switch (level) {
                ...
                case 3:
                    ...
                    DictResult result = Yandex.lookUp(language, text);
